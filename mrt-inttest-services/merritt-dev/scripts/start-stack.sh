...
then
  ...
  aws ecs update-service --cluster $ECS_STACK_NAME --service ezid         --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service ldap         --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service smtp         --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  ...
  aws ecs update-service --cluster $ECS_STACK_NAME --service ingest       --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service inventory    --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service audit        --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
...
then
  ...
  aws ecs update-service --cluster $ECS_STACK_NAME --service db-container --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service minio        --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service ezid         --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service ldap         --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
  aws ecs update-service --cluster $ECS_STACK_NAME --service smtp         --force-new-deployment --desired-count 1 --output yaml --no-cli-pager 
